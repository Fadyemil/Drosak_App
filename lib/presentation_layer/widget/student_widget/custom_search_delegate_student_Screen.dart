...
class CustomSearchDelegateStudentScreen extends SearchDelegate {
  List<StudentModel> searchTerms;
  CustomSearchDelegateStudentScreen({
  ...
  Widget buildResults(BuildContext context) {
    ...
    for (var stage in searchTerms) {
      ...
      if (stage.nameStudent.toLowerCase().contains(query.toLowerCase())) {
